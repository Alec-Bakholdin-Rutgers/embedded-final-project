...
HD_PWD='/home/user/final-project/final-project-vivado/audio-mixer/audio-mixer.runs/system_PmodOLED_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_PmodOLED_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_PmodOLED_0_2.tcl
