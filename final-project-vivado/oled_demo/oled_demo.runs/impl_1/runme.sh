...
HD_PWD='/home/user/final-project/final-project-vivado/oled_demo/oled_demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log oled_demo_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source oled_demo_wrapper.tcl -notrace
