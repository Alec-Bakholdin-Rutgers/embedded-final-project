...
HD_PWD='/home/user/final-project/final-project-vivado/oled_demo/oled_demo.runs/oled_demo_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log oled_demo_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source oled_demo_auto_pc_0.tcl
