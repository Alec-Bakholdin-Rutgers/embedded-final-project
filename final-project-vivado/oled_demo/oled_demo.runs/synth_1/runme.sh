...
HD_PWD='/home/user/final-project/final-project-vivado/oled_demo/oled_demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log oled_demo_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source oled_demo_wrapper.tcl
